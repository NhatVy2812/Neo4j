...
namespace RC
{
    public partial class FormManager : Form
    {
        ...
        {
            InitializeComponent();
            _connection = new Neo4jConnection("bolt://localhost:7687", "neo4j", "123456789");
        }
        ...
        private async void btnAddP_Click(object sender, EventArgs e)
        {
            try
            {
                bool isAdded = await _connection.AddProductAsync(txtPro.Text, tagP, txtPrice.Text, txtAmount.Text, cbbCate.SelectedValue.ToString(), cbbBrand.SelectedValue.ToString(), txtDes.Text);
