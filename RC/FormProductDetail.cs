...
namespace RC
{
    public partial class FormProductDetail : Form
    {
        ...
        private void btnBuy_Click(object sender, EventArgs e)
        {
            ...
            {
                // Giả sử p.Price là giá sản phẩm
                Formcheckout paymentForm = new Formcheckout(_connection,email, p.Name, sl, p.Price);
                paymentForm.ShowDialog(); // Hiển thị form thanh toán
        ...
        public FormProductDetail(Product productName, string e, FormMain formMain)
        {
            _formMain = formMain;
            email = e;
            _connection = new Neo4jConnection("bolt://localhost:7687", "neo4j", "123456789", _formMain);
            p = productName;
            InitializeComponent();
            ...
            motaSP.Text = productName.Description;
